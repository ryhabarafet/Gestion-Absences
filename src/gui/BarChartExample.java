...
public class BarChartExample extends JFrame {  
  ...
  public BarChartExample(String appTitle) {  
    ...
    JFreeChart chart=ChartFactory.createBarChart(  
        "Taux d'absences par classe", //Chart Title  
        "Classe", // Category axis  
  ...
  private CategoryDataset createDataset() {  
    ...
    ArrayList<Statistiques> arr = StatistiqueDao.statNbAbsByClasse();
    ArrayList<String> arr1 = StatistiqueDao.nbSeanceByClasse();
